...
# --- ΡΥΘΜΙΣΕΙΣ ΔΙΑΔΡΟΜΩΝ ΓΙΑ RENDER (LINUX) ---
...
def init_db():
    """Δημιουργία του πίνακα orders αν δεν υπάρχει"""
...
# --- ΚΡΙΣΙΜΟ: Καλούμε την init_db ΕΔΩ ΕΞΩ ---
# Αυτό αναγκάζει το Render/Gunicorn να φτιάξει τη βάση πριν το πρώτο request
init_db()
